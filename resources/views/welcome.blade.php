    ...
    <section class="grid gap-8 lg:grid-cols-2 lg:items-center">
        <div>
            ...
            <div class="flex flex-wrap gap-3">
                <a href="{{ route('login') }}" class="rounded-lg bg-emerald-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-emerald-700">
                    Login
                </a>
                <a href="{{ route('register') }}" class="rounded-lg border border-emerald-200 px-5 py-2.5 text-sm font-medium text-emerald-700 hover:bg-emerald-50">
                    Sign Up
                </a>
            </div>
        </div>
        ...
        <div class="rounded-2xl border border-emerald-100 bg-emerald-50/60 p-6 shadow-sm">
            ...
            <dl class="space-y-3 text-sm">
                <div class="flex items-center justify-between rounded-lg bg-white px-4 py-3">
                    ...
                    <dd class="font-semibold text-emerald-700">₱ 8,500</dd>
                </div>
                <div class="flex items-center justify-between rounded-lg bg-white px-4 py-3">
                    <dt class="text-slate-500">Spent</dt>
                    <dd class="font-semibold text-slate-900">₱ 3,120</dd>
                </div>
                <div class="flex items-center justify-between rounded-lg bg-white px-4 py-3">
                    <dt class="text-slate-500">Remaining</dt>
                    <dd class="font-semibold text-emerald-700">₱ 5,380</dd>
                </div>
            </dl>
        </div>
    </section>
